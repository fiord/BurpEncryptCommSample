...
public class BurpExtender implements IBurpExtender, IHttpListener {
    ...
    public void registerExtenderCallbacks(IBurpExtenderCallbacks callbacks) {
        ...
        // Register ourselves as an HttpListener, in this way all requests and responses
            ...
            if (messageIsRequest) {
                ...
                if (contentParameter != null) {
                    ...
                    try {
                        ...
                        ret = (String) pp.call("callexportfunction", "encryptsampleapp",
                                new String[] { urlDecodedContentParameterValue });
                        pp.close();
                    } catch (Exception e) {
                    ...
                    // Update the messageInfo object with the modified request (otherwise the
                    // request remains the old one)
                ...
                try {
                    PyroProxy pp = new PyroProxy(new PyroURI(pyroUrl));
                    ret = (String) pp.call("callexportfunction", "decryptsampleapp", new String[] { bodyString });
                    pp.close();
                } catch (Exception e) {
                    stderr.println(e.toString());
                    StackTraceElement[] exceptionElements = e.getStackTrace();
